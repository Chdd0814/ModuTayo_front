          ...
          {selectedItem && (
           ...
           <Grid item xs={8}>
             ...
             >
               ...
               <TextField id="standard-basic" label="이름" variant="standard" className="fieldStyles" />
               <TextField id="standard-basic" label="전화번호" variant="standard" className="fieldStyles" />
           ...
           <Grid item xs={4} sx = {{height : '30%'}}>
             ...
             >
               ...
               <Typography sx = {{ textAlign: 'center', fontWeight : 'light', fontSize : 12}}> 원</Typography>
               <Divider/>
